    ...
    <div className="relative container mx-auto mt-10">
      ...
      >
        ...
        <div className="absolute bottom-16 right-4 z-10  gap-2 lg:flex hidden">
          <button className="swiper-prev cursor-pointer bg-[#ff0096] flex justify-center items-center text-white w-10 h-10">
            <FaArrowLeftLong size={15} />
          </button>
          <button className="swiper-next cursor-pointer bg-[#ff0096] flex justify-center items-center text-white w-10 h-10">
